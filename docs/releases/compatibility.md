...
| ---------- | --------------- | --------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `v0.9.0`   | `0.5.0`         | `0.7.0`   | `0.9.0` | Reminder Tag 词表、全文/标签搜索（`q`/`tag`）、事项跟踪条目（`track-entries`）；CLI `--tag`/`--q`/`track add`；小程序搜索栏与跟踪 UI。需 API 迁移 `20260701_0018`。 |
| `v0.8.7`   | `0.4.2`         | `0.6.1`   | `0.8.7` | 小程序修复版：头像缓存与展示更稳定；修复提醒事项时间显示/调度错位问题。API/CLI 无变更。                                                                             |
