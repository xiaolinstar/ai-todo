...
- `0.7.0`：内测 UX 稳定、来源角标、列表分组、CLI 英文输出（见 [v0.7.0.md](./v0.7.0.md)）。
...
- `0.8.10`：发布可靠性与登录体验收口；K8s app/db/migration 生命周期解耦，CD 健康检查更稳，小程序未登录错误统一唤起登录（见 [v0.8.10.md](./v0.8.10.md)）。
